                ...
                <div class="container">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="card text-center single-pricing-pack mt-4">
                                <div class="pt-5">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="card popular-price text-center single-pricing-pack mt-4">
                                <div class="pt-5">
                        ...
                        <div class="col-12">
                            <div class="support-cta mt-5">
                                <h5 class="mb-1 d-flex align-items-center justify-content-center gap-2"><span
                                        class="ti-loop color-primary mr-3 icon-sm"></span>Choose Your <a
                                        href="pricing-comparison.html" class="ml-2 text-decoration-none">Compare Hosting
                                        Plans</a></h5>
                            </div>
                        </div>
                    </div>
