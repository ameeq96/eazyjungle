                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-4">
                                <img src="{{ asset('img/icon-shared-hosting.png') }}" alt="shared hosting"
                                ...
                                <div class="action-wrap mt-3">
                                    ...
                                    <a href="#" class="btn-link text-decoration-none">View Details <span
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-4">
                                <img src="{{ asset('img/icon-wordpress-hosting.png') }}" alt="shared hosting"
                                    class="img-fluid mb-4" width="45" />
                                <div class="service-plane-content">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-4">
                                <img src="{{ asset('img/icon-vps-hosting.png') }}" alt="shared hosting"
                                    class="img-fluid mb-4" width="45" />
                                <div class="service-plane-content">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-4">
                                <img src="{{ asset('img/icon-website-builder.png') }}" alt="shared hosting"
                                    class="img-fluid mb-4" width="45" />
                                <div class="service-plane-content">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-4">
                                <img src="{{ asset('img/icon-dadicate-hosting.png') }}" alt="shared hosting"
                                    class="img-fluid mb-4" width="45" />
                                <div class="service-plane-content">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-4">
                                <img src="{{ asset('img/icon-cloud-hosting.png') }}" alt="shared hosting"
                                    class="img-fluid mb-4" width="45" />
                                <div class="service-plane-content">
