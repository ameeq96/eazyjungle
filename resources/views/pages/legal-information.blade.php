...
{{-- === SEO meta for Legal Information === --}}
@section('title', 'Legal Information')
@section('meta_description', 'Read EazyJungle’s legal information: company registration, licensing, disclaimers, IP rights, privacy and governing law for using our website and services.')
@section('canonical', url('/legal-information'))
@section('og_type', 'website')
@section('og_image', asset('img/og/legal-information.jpg')) {{-- fallback: img/og/default.jpg --}}
...
<script type="application/ld+json">
{
  ...
  "url":"{{ url('/legal-information') }}",
  "description":"Company registration, licensing, disclaimers, intellectual property rights, privacy and governing law."
}
</script>
<script type="application/ld+json">
{
  ...
  "itemListElement":[
    ...
    {"@type":"ListItem","position":2,"name":"Legal Information","item":"{{ url('/legal-information') }}"}
  ]
}
</script>
@endpush
...
<section class="py-5">
  <div class="container">
    ...
    <p>
      ...
      - While we strive to keep all content accurate and up to date, we do not guarantee completeness or reliability.<br>
